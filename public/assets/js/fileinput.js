...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Arquivo "{name}" (<b>{size} KB</b>) excede o tamanho máximo permitido de carregamento de <b>{maxSize} KB</b>. Por favor, tente novamente seu upload!',
        msgFilesTooMany: 'Número de arquivos selecionados para upload <b>({n})</b> excede o limite máximo permitido de <b>{m}</b>. Por favor, tente novamente seu upload!',
        msgFileNotFound: 'Arquivo "{name}" não encontrado!',
        msgFileNotReadable: 'Arquivo "{name}" não é legível.',
        msgFilePreviewAborted: 'visualização de arquivo abortada para "{name}".',
        ...
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Erro ao carregar arquivo</span>',
        msgErrorClass: 'file-error-message',
        msgLoading: 'Carregando arquivo {index} de {files} &hellip;',
        msgProgress: 'Carregando arquivo {index} de {files} - {name} - {percent}% concluído.',
